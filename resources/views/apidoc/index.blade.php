...
<h3>HTTP Request</h3>
<p><code>GET api/movies/{movie}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT api/movies/{movie}</code></p>
<p><code>PATCH api/movies/{movie}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE api/movies/{movie}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET api/casts/{cast}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT api/casts/{cast}</code></p>
<p><code>PATCH api/casts/{cast}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE api/casts/{cast}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET api/theaters</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>POST api/theaters</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET api/theaters/{theater}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT api/theaters/{theater}</code></p>
<p><code>PATCH api/theaters/{theater}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE api/theaters/{theater}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET api/show-times</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>POST api/show-times</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET api/show-times/{show_time}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT api/show-times/{show_time}</code></p>
<p><code>PATCH api/show-times/{show_time}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE api/show-times/{show_time}</code></p>
